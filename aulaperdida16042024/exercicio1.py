...
# Neste exemplo, a classe ContaBancaria possui métodos getters e setters para
# os atributos titular e saldo, além de um método depositar para adicionar dinheiro à conta.
